...
.. note:: This version history is no longer maintained. Please head over to GitHub to see the latest Mapbender `Changelog <https://github.com/mapbender/mapbender/blob/master/CHANGELOG.md>`_ and `Version Milestones <https://github.com/mapbender/mapbender/milestones?direction=desc&sort=title&state=closed>`_.
