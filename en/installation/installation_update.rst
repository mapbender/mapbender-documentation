...
* save your configuration files (``parameters.yml`` for versions < 4.0.0, .env.local for >= 4.0.0 and files from folder config) and your old Mapbender (files and database)
...
.. code-block:: bash
 ...
 # transfer the information from parameters.yml to .env.local and /var/www/mapbender/config/parameters.yaml
