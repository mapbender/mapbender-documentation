...
Moreover, you can set the following parameter to your preferred language in the configuration file **app/config/parameters.yml**. If a translation should be missed, the set language instead will be used.
