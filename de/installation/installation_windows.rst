...
5. In der SYSTEM-Konsole das puppeteer Modul im mapbender bzw. application-Verzeichnis (bei git-basierter Installation) des Mapbender (nicht global!) installieren:
