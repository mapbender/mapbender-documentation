...
* Information zur Benutzung von Layersets finden Sie in der `Quickstart Dokumentation <../../quickstart.html#konfiguration-von-diensten>`_

* Die Bedeutung der Layersets für die Anzeige im Layertree ist im Abschnitt zu den Thematischen Layern in der `Layertree-Dokumentation <../basic/layertree.html>`_ beschrieben.

* Ebenso können einzelne Layersets in der `Karte <../basic/map.html>`_ an- und abgeschaltet werden.
